#ifndef _LVGlobs_h
#define _LVGlobs_h
#define	HOST_IP_ADDRESS	"192.168.10.52"
...
extern void Webpublish_AddVIGlobalConstants(void);
VoidFn globConstInitTable[] = {
	Filler,

	Webpublish_AddVIGlobalConstants,
};
...
extern void Webpublish_CleanupLSRs(void);
VoidFn lsrCleanupTable[] = {
	Filler,

	Webpublish_CleanupLSRs,
};
#else
